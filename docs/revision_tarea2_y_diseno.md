...
> **Actualización (mejoras metodológicas):** el deck pasó a **26 láminas principales + 14 anexos** (40 en total) al añadir "Modificadores ópticos APLICADOS", "Recurso REAL de Atacama (PVGIS TMY)" y un anexo inicial de "Librerías y Herramientas de Código". Se implementaron IAM + corrección espectral, albedo 0.20, integración de energía a 5 min, recorte de doble cobertura (ventana de 12 meses) y un track con recurso meteorológico real de Atacama (fuente: PVGIS / JRC, Comisión Europea). Resultados vigentes: PR emulado m-Si 81.61 % / HIT 84.18 % (+2.57 pts); PR real m-Si 83.82 % / HIT 84.99 % (+1.17 pts); economía 100 MWp +3,294 MWh / +USD 148k al año. La numeración del footer ahora es N/40. El checklist de cumplimiento de la pauta (abajo) sigue satisfecho en todos sus ítems.
